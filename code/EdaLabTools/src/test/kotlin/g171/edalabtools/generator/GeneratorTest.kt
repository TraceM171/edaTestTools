...
internal class GeneratorTest {
    ...
    fun setUp() {
        ...
        expectedFile = File(javaClass.getResource("/LabTests/results/Practica.LabTests").file)
    }
    ...
    fun `is Generator output correct`() {
        ...
        Generator().generate(
            LabTestInfo(
                ...
                MIN_NOTA = 0.0,
                CAP = arrayOf(
                    "EDA GIA. Examen Práctica 1. Curso 2020-21.",
                    "EDA GII - First Lab Exam. Academic Year 2019-20."
                ),
                LIN = "========================================================",
                ...
                NO_AUT = arrayOf(
                    "*** Examen fuera de plazo o no autorizado.",
                    "*** Unauthorized access or lab exam out of time."
                ),
                EXC_TM = arrayOf(
                    "TIEMPO TEST EXCEDIDO: ¿Bucle infinito? ",
                    "Test Run Time Limit Exceeded: probable infinite loop. "
                ),
                EXC = arrayOf("EXCEPCION: ", "EXCEPTION: "),
                ERR = arrayOf("ERROR: ", "ERROR: "),
                NO_METHOD = arrayOf(
                    "No existe el metodo que se quiere ejecutar.",
                    "The method to be tested does not exist."
                ),
                ...
                absPath = "/home/trace/ingInfPracts/2n/2quatri/eda/./aplicaciones/primitiva/Practica1.LabTests"
            ),
            outputFile.path
        )
